...
import static awesomecucumber.api.SpecBuilder.getRequestSpec;
import static awesomecucumber.api.SpecBuilder.getResponseSpec;
...
public class ApiRequest {
    ...
    public static Response post(String endPoint, Headers headers,
            ...
            return given(getRequestSpec()).headers(headers).formParams(formParams).cookies(cookies).
                    when().post(endPoint).
